...
import com.example.tool.user.request.ChangePasswordRequest;
...
public class UserController {
    ...
    public AuthResponse changePassword(@Valid @RequestBody ChangePasswordRequest req,
                                       @AuthenticationPrincipal CustomUserDetails userDetails) {
        return userService.changePassword(userDetails.getUserId(), req.getOldPassword(), req.getNewPassword());
    }
}
